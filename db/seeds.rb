...
WorkOrder.create(client: ipd, dueDate: 9.day.from_now, status: active_status, project_type: other_project, projectDescription: "Black Book Mailing", quantity:10000)
WorkOrder.create(client: menorah_manor, dueDate: 7.day.from_now, status: active_status, project_type: other_project, projectDescription: "Monthly Newsletter", quantity: 5000)
WorkOrder.create(client: bgs, dueDate: 30.day.from_now, status: active_status, project_type: other_project, projectDescription: "Amora Coffee", quantity: 375)
